...
function Banner() {
  ...
  <div className='max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
    <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
        ...
        <h1 className="text-4xl font-bold">
            ...
            <p className='text-xl'>Here you will get delicious and fresh foot items at dicounted rate<br />
            *No tax apply
            </p>
  ...
  <input type="tel" className="grow" placeholder="Phone Number" />
    ...
    <button className="btn mt-6 btn-primary">Subscribe here</button>

    </div>
    <div className='order-1 w-full md:w-1/2'>
        <p><br/><br/>
        </p>
        <img src={Food} className='w-100 h-92' alt='' />
    </div>
  </div>
  </>
  )
